...
$meta_boxes = array(
    ...
    array(
        ...
        'pages' => array('post', 'page', 'gallery', 'services'), // multiple post types
        'context' => 'side',
        'priority' => 'high',
        'fields' => array(
            array(
    ...
    array(
        ...
        'fields' => array(
            ...
            array(
                'name' => __('Show In Reservations', tk_theme_name()),
                'desc' => 'If checked this member will be available for reservations',
                'id' => $prefix . 'show_reservations',
                'type' => 'checkbox'                
            ),
            
            array(
                'name' => __('Assign member to service', tk_theme_name()),
                'desc' => 'Assign member to certain service so he/she can be filtered in Reservations page',
