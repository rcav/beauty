...
<?php } elseif ($get_post_type == 'news') { ?>
    ...
    <div class="half-width left">
        ...
        <div class="flexslider-part-news-left flexslider-news-wrap flex-news-slide flexslider-part-news-left<?php echo $post_id; ?>">
            <div class="home-title-nav left">
            ...
            <div class="flexslider flexslider-news-left flexslider-news-left<?php echo $post_id; ?>">
                    ...
                    <ul class="slides">
                        ...
                        ?>                                
                            <li>
                                <div class="home-latest-news-one left-news-class left">                            
...
<?php } elseif ($get_post_type == 'testimonials'){ ?>
    ...
    <div class="half-width left">
        ...
        ?>
            <div class="home-testimonials-one left">
                <div class="home-testimonials-one-content left">  
                    ...
                    <?php } ?>
                    <div class="home-testimonials-one-titile testimonials-title-half <?php if(empty($tk_email)){ echo'post-fullwidth'; } ?> left">
           ...
           <?php } elseif($get_post_type == 'team') { 
                ...
                ?>
            <div class="horizontal-slider half-width horizontal-half left">               
               <div class="home-title-nav slider-width-auto left">
                    <?php if(!empty($sub_team_left)) ?><span><?php echo $sub_team_left; ?></span>
                </div>

                <script type="text/javascript"> 
                    //making responsive thumbnails, recalls flexslider on resize
                        jQuery(window).load(function() {
          ...
          <?php  } elseif($get_post_type == 'adbanner'){ 
                ...
                ?>
                <div class="home-content-ad half-width left">
        ...
        <?php } elseif($get_post_type=='content') {
            ...
            ?>
            <div class="home-page-content half-width left">
...
if($get_post_type_col_right == 'services') {
    $get_service = get_option('sub_services_right-'.$post_id);
                ...
                ?>
            <div class="half-width last-width  left">
                    <?php
                    if(!empty($services_title_right)){ ?>
                        <div class="home-title-nav left">
...
<?php } elseif ($get_post_type_col_right == 'news') {
   ?>
                ...
                <script type="text/javascript">
                        ...
                        var sliderWidth = jQuery('.flexslider-news-right<?php echo $post_id ?>').width();
    ...
    <div class="half-width last-width left">
        ...
        <div class="flexslider-news-wrap flex-news-slide halfwidth-flex">
            <div class="home-title-nav left">
    ...
    <div class="flexslider-part-news flexslider-part-news-right<?php echo $post_id; ?>">
        <div class="flexslider flexslider-news flexslider-news-right<?php echo $post_id; ?>">
        ...
        <?php
            ...
            ?>
            <li>
                <div class="home-latest-news-one last-width right-news-class  left">                            
                        <?php if(has_post_thumbnail() || $format =='video' || $format == 'gallery'){ ?>
                            <div class="home-latest-news-one-image left">
                                <a href="<?php the_permalink();?>">                                                
...
<?php } elseif ($get_post_type_col_right == 'testimonials'){ ?>
    ...
    <div class="half-width last-width left">
        ...
        ?>
           ...
           <div class="horizontal-slider half-width horizontal-half last-width left"> 
               
                         
               <div class="home-title-nav slider-width-auto left">
                    <?php if(!empty($sub_team_right)) ?><span><?php echo $sub_team_right; ?></span>
                </div>
          ...
          <?php  } elseif($get_post_type_col_right == 'adbanner'){ 
                ...
                //tk_add_banner_view($ad_post);
                ?>
                <div class="home-content-ad half-width last-width left">
        ...
        <?php } elseif($get_post_type_col_right =='content') {
            ...
            ?>
            <div class="home-page-content half-width last-width left">
                <div class="shortcodes" style="margin:0">
                    <?php wp_reset_query();
                    query_posts('page_id='.$page_content);
                    if (have_posts()) : while (have_posts()) : the_post();
